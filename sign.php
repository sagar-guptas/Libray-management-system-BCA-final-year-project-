                ...
                <div class="form-container">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-section">
                            ...
                            <input type="text" id="dob" name="roll" placeholder="Enter your Roll" required>
...
if (isset($_POST['submit']))
{
    ...
    $gender = $_POST['gender'];
     ...
     $querr = "INSERT INTO student VALUES ('$name','$username','$password','$rePassword','$email','$phone','$dob','$roll','$gender')";
